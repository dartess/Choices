...
// Array.from-like helper without setting Array.from
// Production steps of ECMA-262, Edition 6, 22.1.2.1
// Reference: https://people.mozilla.org/~jorendorff/es6-draft.html#sec-array.from
const arrayFrom = Array.from || (function() {
...
export const getAdjacentEl = (startEl, className, direction = 1) => {
  ...
  const children = arrayFrom(parent.querySelectorAll(className));
...
/**
 * Array.from or polyfill-like Array.from
 */
export {arrayFrom};
